...
C1_substitution_constants = [Init_number_adverts, adv_lost, subs_lost_adv, Init_price_advert];
C1_substitution_values = [350,  50/100, 1000/50, 250];
...
substitution_values = [80000, 50/100, 1.50, 350,  1000/50, 5000/.1, 250, 1.539039039039039039039039039039, 359.60960960960960960960960960961];
...
disp(['optimal x = ' num2str(1.539039039039039039039039039039)]);
disp(['optimal y = ' num2str(359.60960960960960960960960960961)]);
